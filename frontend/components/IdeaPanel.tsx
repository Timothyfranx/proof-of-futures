...
export default function IdeaPanel({ ideas, phase, onInject }: IdeaPanelProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-slate-900/30 custom-scrollbar">
      {/* Entire content flows in one scrollable container */}
      <div className="flex flex-col min-h-full">
        
        {/* Inject form section */}
        <div className="px-4 py-4 border-b border-white/5 bg-slate-900/50 backdrop-blur-sm">
